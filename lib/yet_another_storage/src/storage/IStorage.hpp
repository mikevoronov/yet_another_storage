...
class IStorage {
 public:
  ...
  virtual nonstd::expected<std::any, StorageErrorDescriptor> Get(key_type key) const = 0;
  virtual nonstd::expected<bool,     StorageErrorDescriptor> HasKey(key_type key) const = 0;
