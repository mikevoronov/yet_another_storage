 ...
 public:
  ...
  static EntryType ConvertToEntryType(PVType pv_type, Type &&value) {
    ...
    case PVType::kFloat:
      ...
      return Float_EntryType(*(reinterpret_cast<Float_EntryType::ValueType *>(&value)) );
    case PVType::kInt64:
    ...
    case PVType::kDouble:
      ...
      return Double_EntryType(*(reinterpret_cast<Double_EntryType::ValueType *>(&value)));
    }
  ...
  template<>
  static EntryType ConvertToEntryType<ByteVector>(PVType pv_type, ByteVector &&value) {
    switch (pv_type) {
    case PVType::kString: {
