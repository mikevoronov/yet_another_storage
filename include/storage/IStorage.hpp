...
class IStorage {
 public:
  ...
  virtual StorageErrorDescriptor Put(key_type key, storage_value_type value) = 0;
  virtual nonstd::expected<storage_value_type, StorageErrorDescriptor> Get(key_type key) = 0;
